...
const char* serverUrl1 = "http://192.168.1.142:5000/receive_door_status_data";
const char* serverUrl = "http://192.168.1.142:5000/receive_temp_hum_data";  // Replace with your Flask server URL

const char* host = "192.168.1.130";
IPAddress local_IP("192.168.1.128"); // Set your desired static IP address
